    ...
    void UI::app_home(){
      ...
      if(enter==1){
        if(cursor_home == 0){
          ...
          cursor_val_int = 1;//////////////////////////////////////////デフォルトをディフェンスに(0はアタッカー)
          sound.enter();
        }
      }
      //カーソル移動
  ...
  //       }
    ...
    void UI::app_logo(){
      ...
      if(back!=0){
        ...
        void UI::app_cam(){
          ang_blue = data.dp.blue_angle;
          cd_blue = data.dp.blue_distance;
          ang_yellow = data.dp.yellow_angle;
          cd_yellow = data.dp.yellow_distance;
