...
# LAB色空間で青色検出
# ===============================
blue_threshold = [(61, 76, -10, 9, 10, 74)]
#A Blue: (23, 47, 4, 41, -128, -36)
#A Yellow: (61, 76, -10, 9, 10, 74)
#B Blue:(27, 41, 14, 66, -100, -9)
#B Yellow:(64, 77, -8, 12, 4, 67)
#C Blue: (24, 45, 18, 59, -85, 15
#C Yellow:(58, 77, -21, 5, 5, 75)
