...
#include <Arduino.h>
ReadPacketData0 rp0;//メインESP32と
ReadPacketData1 rp1;//カメラと
ReadPacketData2 rp2;//超音波と
...
// ========= UART 初期化 =========
void initUART() {
  Serial.begin(230400);//toMAIN ESP32
  Serial1.begin(115200, SERIAL_8N1, 19, 18);  //TX, RX // to カメラ !!ピン注意！
